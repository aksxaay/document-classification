            ...
            <div>
              ...
              <Link to="/">
                <div className="flex items-center space-x-4 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                  ...
                  <span className="font-semibold">ºdissonance™</span>
                </div>
              </Link>
            </div>
          ...
          <div>
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {navigation.map((item, index) => (
                <Link key={index} to="/">
                  <a className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:focus:bg-gray-700">
                    {item}
                  </a>
                </Link>
              ))}
