        ...
        <div className="flex w-full items-center lg:w-1/2">
          <div className="mb-8 max-w-2xl">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 dark:text-gray-300 lg:text-xl xl:text-2xl">
              <span className="font-semibold">ºdissonance</span> is a free
              Document Classification System website for Data Entry Document
              Classification and indie developers. Its built with React &
